...
1 Use the setup file to install DexCoin GUI Wallet

2 Default Location of DexCoin's root Directory in Windows is:
    
    32-bit: Program Files/DexCoin
    64-bit: Program Files (x86)/DexCoin

3 Go to DexCoin's root directory and run DexCoin-qt.exe

4 Data Directory is located at: Users/your_windows_user/AppData/Roaming/DexCoin
